...
int hazard_part(int nSpecies, int nRxns, const int *anPre, const int *anX, int *anHp);
...
int update_species(int nSpecies, int nRxns, const int *anStoich, const int *anRxns,    
                    int *anX);
