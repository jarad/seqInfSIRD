...
void hazard_part_wrap(int *, int *, int *, int *, const int *, int *);
int hazard_part(Sckm *sckm, const int *anX, int *anHp);

void hazard_wrap(int *, int *, int *, int *, const double *, const int *, double *, int *, double *);
int hazard(Sckm *sckm, const double *adTheta, const int *anX, double dTau, int *anHp, double *adH); 

void update_species_wrap(int *, int *, int *, int *, const int *, int *);
int update_species(Sckm *sckm, const int *anRxns, int *anX);

void tau_leap_one_step_wrap(int *, int *, int *, int *, const double *, int *, int *, int *);
int tau_leap_one_step(Sckm *sckm, const double *adH, int nWhileMax, int *anRxns, int *anX);

void tau_leap_wrap(int *nSpecies, int *nRxns, int *anPre, int *anPost, 
...
void gillespie_wrap(int *nSpecies, int *nRxns, int *anPre, int *anPost, 
